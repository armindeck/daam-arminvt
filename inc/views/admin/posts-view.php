<?php
// overview, new, edit, preview
$type = "overview";
?>
<main class="flex flex-evenly flex-1">
	<form method="post" class="form-3">
		<div class="flex flex-column gap-6">
			<h2 class="p-8 t-center">Posts</h2>
			<?php if ($type == "overview"): ?>
				<h3>Publicar</h3>
				<div class="flex flex-evenly items-center t-center">
					<a class="boton-transparent flex-1" href="?sc=posts&new=blog"><i class="fas fa-plus"></i> Blog</a>
					<a class="boton-transparent flex-1" href="?sc=posts&new=page"><i class="fas fa-plus"></i> Page</a>
				</div>
				<hr>
				<h3>Publicaciones</h3>
			...
			<label for="page_template">Plantilla:</label>
			<select name="page_template" id="page_template" style="max-width: 100%;">
		...
		<div class="flex flex-between p-8">
			...
			<button class="boton" type="submit" name="proccess" value="posts">
				💾 Guardar
			</button>
		</div>
		-->
