...
<b>Imagenes</b> > <a class="boton2" target="_blank" href="../../imagenes">Mostrar</a><hr>
            ...
            <textarea class="oculto" name="leer"><?php $mos=htmlspecialchars(file_get_contents($AC_DIRECTORIO.'administracion/panel/sms.php')); echo $mos; ?></textarea>
            <span>Activar mensaje <input type="checkbox" name="texMensaje" <?php
    if($texMensaje==true){ echo 'checked'; } ?>></span><br>
            <span>Activar aunucio <input type="checkbox" name="mosAnuncio" <?php
    if($mosAnuncio==true){ echo 'checked'; } ?>></span><br><span>Activar aunucio2 <input type="checkbox" name="mosAnuncio2" <?php
    if($mosAnuncio2==true){ echo 'checked'; } ?>></span>
            <div>
