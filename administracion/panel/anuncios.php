    ...
    <form method="post" action="actualizar.php">
        <div class="formulario">
            ...
            if(isset($texMensaje) && $texMensaje==true){ echo 'checked'; } ?>></span>
                <span>Anuncio <input type="checkbox" name="mosAnuncio" <?php if(isset($mosAnuncio) && $mosAnuncio==true){ echo 'checked'; } ?>></span>
                <span>Anuncio2 <input type="checkbox" name="mosAnuncio2" <?php if(isset($mosAnuncio2) && $mosAnuncio2==true){ echo 'checked'; } ?>></span><hr>
                <div>
