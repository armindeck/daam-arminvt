...
if($elem==1): #MENU
	if($ii==0){
		if(isset($scrUS_MenuBotones) && $scrUS_MenuBotones!=''){
			echo '<a title="'.$NombreWeb.'" href="'.$AC_DIRECTORIOs.'"><i class="fas fa-inicio"></i> Inicio</a><!-- home -->
			...
			<a title="Canal: '.$NombreWeb.'" href="'.$EnlaceYouTube.'?sub_confirmation=1" target="_blank"><i class="fab fa-youtube"></i> Sígueme</a>';
		}
	}
endif;
