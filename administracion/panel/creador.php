...
if (isset($permiExtras) && $permiExtras == true) {
    ...
    switch ($opc9) {
        ...
        case 'busqueda': $opc9Busqueda='selected'; break;
...
<p class="texini">Creemos algo epico!</p>
    ...
    <div class="flexCrear">
        ...
        <div class="formulario">Herramientas<hr>
            <form>
                <label>Scripts <input type="checkbox" name="opcmostrar">
                    <a target="_blank" class="boton2" href="panel.php?ac=editor&u=scripts&c=Creador">Scripts <i class="fas fa-external-link-alt"></i></a>
                    <input type="submit" value="Cargar &#xf07c">
                </label>
            </form><hr>
            ...
            <form method="post" action="panel.php?ac=creador">
                ...
                <label>Modificador</label> <input type="text" name="archivo" placeholder="cn_ubicar-archivo">
        ...
        <form class="formulario" action="borrador.php<?php if (isset($_GET['opcBorrador'])) { echo '?opcBorrador='.$_GET['opcBorrador']; } ?>" method="post">
            ...
            <textarea class="texeditor2" name="opc7" placeholder="Contenido"><?php if(isset($opc7)){ echo $opc7; }; ?></textarea>
            ...
            <span>Tipo</span> <select name="opc9">
                ...
                <option value="busqueda" <?php if(isset($opc9Busqueda)){ echo $opc9Busqueda; }; ?>>Busqueda</option>
        ...
        <div class="flexCrearSugerencias">
            ...
            <ol>
                ...
                <li>Disfruta de la versión 0.3.3 Beta mejorada!</li>
