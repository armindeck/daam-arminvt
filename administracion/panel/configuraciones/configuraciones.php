<?php if(isset($TIPO) && $TIPO=='panel'){ ?>
	<p class="texini">Configuración avanzada <span class="t12"><?php echo file_get_contents(__DIR__.'/configuraciones.x'); ?></span></p>
<form class="flexCon" method="post" action="configuraciones/procesa.php">
	...
	<span>Publicada:</span> <input type="number" name="cfg_anio_publicada" value="<?php echo $AnioPublicada; ?>" placeholder="Año publicada"><hr>
