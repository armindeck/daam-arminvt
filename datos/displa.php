...
$extraContenidoExtra=$dirExtra.'ContenidoExtra/scrContenidoExtra.php';

if (file_exists($extraContenidoExtra)) { require_once $extraContenidoExtra; } else { $ContenidoExtra=false; }
...
<head>
    ...
    <link rel="preload" href="<?php echo $AC_DIRECTORIO; ?>logo.png" as="image">



    <link rel="icon" type="image/png" href="<?php echo $AC_DIRECTORIO; ?>logo.png" sizes="128x128">
    ...
    <?php
        ...
        <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1879876946467439"
...
<?php if (isset($ContenidoExtra) && $ContenidoExtra == 'on'): ?>

<div>

    <?php for ($i=1; $i <=$ContenidoExtraElementos; $i++):

        $ex='ContenidoExtraElementos'; require $AC_DIRECTORIO.'datos/extenciones.php';
        ...
        if($vaLM == 'on'): if($vaLT != ''){ echo '<p>'.$vaLT.'</p><hr>'; }
            ...
            $arcMNL=$AC_DIRECTORIO.'/administracion/panel/scripts/ContenidoExtra/scrDisplaContenidoExtra.php';

            if(file_exists($arcMNL)){ require $arcMNL; }

            #EL USUARIO PUEDE CREAR SUS PROPIOS SCRIPTS >>>>>>>>>>>> ?>

<?php endif; endfor; echo '</div>'; endif; ?>
