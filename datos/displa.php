...
<head>
    ...
    <!--
        Theme Name: <?= INFO['name']; ?>' Theme
        Theme URL: <?= INFO['url']."\n"; ?>
        Version: <?= INFO['version']."\n"; ?>
        Author: <?= INFO['author']."\n"; ?>
        Author URL: <?= INFO['author-url']."\n"; ?>
    -->
    ...
    <?php
        ...
        if(isset($PermisoPorElUsuarioTema) && $PermisoPorElUsuarioTema==true){
            switch ($TemaPorElUsuario) {
                case 'temaLight': $tmuse='tema_Light'; break;
                case 'temaLight2': $tmuse='tema_LightGXNCV5'; break;
                case 'temaDark': $tmuse='tema_Dark'; break;
                case 'temaDark2': $tmuse='tema_DarkPCGAMEXBOXV6'; break;
                case 'temaBlue': $tmuse='tema_DarkCuniiCh'; break;
                default:
                    $tmuse='';
                    break;
            }
