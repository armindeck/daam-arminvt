...
$AC_METADESCRIPCION='Aprende a crear un Menu Epico con Game Maker';
$AC_METADESCRIPCION2='Como hacer un menu de inicio con Game Maker';
$AC_METAETIQUETA='Como crear un menu en game maker desde cero,Tutorial completo de como crear un menu con game maker,Como hacer un menu game maker,crear menu game maker,game maker menu,como hacer un menu en game maker studio,como hacer un menu en game maker 8,menu epico game maker,como hacer un menu con game maker,menu avanzado con game maker,como hacer un menu,el mejor menu,el mejor menu con game maker,menu de inicio game maker,como hacer un menu de inicio por codigo game maker';
$AC_IMG='menuepicogms.png';
$AC_EXTRA=true;
